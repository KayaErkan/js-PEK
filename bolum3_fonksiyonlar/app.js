...
function getRandomInt(sayi) {
  return Math.floor(Math.random() * sayi);
}
// //*************************************** */
// zaman olursa bunu da çöz
...
function tekCift(sayimiz) {
  return sayimiz % 2 == 0 ? `${sayimiz} Çifttir` : `${sayimiz} Tektir`; //burayı bir değişkene atayıp onu return etsekte olur
}
